...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <h1 class="text2xl font-extrabold text-gray-900 dark:text-white md:text-2xl lg:text-2xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-purple-400">Moist</span> Skincare</h1>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <a href="/katalog" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Products</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        @else
                            <a href="{{ route('login') }}" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                                Login
                            </a>
                        @endauth
                    </li>
    ...
    <div class="container mx-auto p-6">
        ...
        @if(count($cart) > 0)
            ...
            <p class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Subtotal: Rp {{ number_format($totalPrice, 0, ',', '.') }}</p>
            <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">Discount: Rp {{ number_format($discountAmount, 0, ',', '.') }} ({{ $discountPercentage }}%)</p>
            <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">Total: Rp {{ number_format($finalPrice, 0, ',', '.') }}</p>
