...
<body>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a class="mb-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                ...
                @foreach ($products as $product)
                    <div class="room-card max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 font-normal text-gray-700">Harga : Rp
