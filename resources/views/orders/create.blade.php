    ...
    <div class="container mx-auto p-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white dark:bg-gray-800">
                <thead>
                    <tr>
                        <th class="py-2 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400">Product Name</th>
                ...
                <tfoot>
                    <tr>
                        <td colspan="2" class="py-2 px-4 text-right text-gray-900 dark:text-white font-bold">Total Price:</td>
                        <td class="py-2 px-4 text-gray-600 dark:text-gray-400">{{ $totalPrice }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <form action="{{ route('orders.store') }}" method="POST" class="mt-4">
            @csrf
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">Place Order</button>
        </form>
    </div>
</body>
</html>
